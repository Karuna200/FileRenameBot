class Translation(object):
    START_TEXT = """ <b> Hi {} , \nI'm A Simple But Fast File Renamer+File To Video Converter Bot With Permanent Thumbnail And Custom Caption support!</b> \n

<b>Bot Maintained By: @TVSeriesCW </b> \n 
"""
    ...
    AFTER_SUCCESSFUL_UPLOAD_MSG = "<b>Thank you for Using Me Support Our Channel @TVSeriesCW ❤️</b>"
    SAVED_CUSTOM_THUMB_NAIL = "<b> Yo , Your thumbnail Saved ✅ This Is Permanent Until</b> /delthumb ❤"
    DEL_ETED_CUSTOM_THUMB_NAIL = "I'm Just Following Your Orders , thumbnail cleared succesfully🤦"
    ...
    HELP_USER = """Checkout The Available Commands Here \n\n Do Follow @TVSeriesCW If You Find This Bot Usefull❤️"""
